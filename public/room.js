...
$(function() {
  ...
  function generateName() {
    const adj = ['水藍色的', '洗澡中的', '愛喝水的', '緋紅', '黃色', '釉綠色的', '粉紅色的', '淡紫色的', '黑白', '黯綠色的', '褐色的', '金黃','美麗','漂亮','開開心心','怒','尷尬','時間管理','努力的','忿忿不平','嘻嘻哈哈','淺藍','閃亮','暗', '好奇', '帥氣', '討人喜愛的', '受人喜歡的', '天然呆的', '圓滾滾的', '懶洋洋的', '烏拉拉的', '尖叫的', '正在條繩的', '奔跑的', '在唱歌的', '跌倒的', '在游泳的', '戴balenciaga老帽的', '穿saligia內褲的', '在看youtube的', '在拍抖音的', 'ig粉絲10萬的', '聽black pink的', '厭世的', '在omni蹦迪的', '在klash嗨的', '正在呼吸的', '無聊的', '好笑的']
