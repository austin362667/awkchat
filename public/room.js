...
$(function() {
  ...
  // });
    ...
    $joinGame.click(function () {
      location.href = 'https://lattemall.company'
      // leaveGame();
      // joinGame();
  ...
  function generateName() {
    const adj = ['水藍色的', '洗澡中的', '愛喝水的', '緋紅', '黃色', '釉綠色的', '粉紅色的', '淡紫色的', '黑白', '黯綠色的', '褐色的', '金黃','美麗','漂亮','開開心心','7噗噗的','尷尬','時間管理','努力的','忿忿不平','嘻嘻哈哈','淺藍','閃亮','暗', '好奇', '帥氣', '討人喜愛的', '受人喜歡的', '天然呆的', '圓滾滾的', '懶洋洋的', '烏拉拉的', '尖叫的', '正在條繩的', '奔跑的', '在唱歌的', '跌倒的', '在游泳的', '戴balenciaga老帽的', '穿saligia內褲的', '在看youtube的', '在拍抖音的', 'ig粉絲10萬的', '聽black pink的', '厭世的', '在omni蹦迪的', '在klash嗨的', '正在呼吸的', '無聊的', '好笑的', '嘟嘟嘴的˙']
    const n = ['寶寶','獨角獸','大師','打工仔','老司機','美少女','葛格','恐龍化石','小寶貝','水水','大學生','小強','小學生', '香蕉','教授','鯊魚','饒舌歌手','湯姆貓','米奇老鼠','小飛象','小公主','美人魚','花木蘭', '柴柴', '小水獺', '小企鵝', '小公雞', '小貓咪', '肥肉', '西瓜', '飯糰', '油條', '奶茶', '三明治', '熱狗', '火腿', '那種人', '邱比特', '大胃王', '蛋餅', 'apple', '拔剌', '水蜜桃', '鳳梨', '狗狗', '小可愛', '蝦仁', '貢丸', '湯圓', 'converse1970', '葡萄','哈密瓜', '吐司夾蛋', '草莓','水梨','豆漿','白玉歐雷', '奇異果', '釋迦', '番茄'] 
