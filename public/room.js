...
$(function() {
  ...
  function generateName() {
    const adj = ['水藍', '寶藍', '多喝水', '緋紅', '黃色', '釉綠', '粉紅', '淡紫', '黑白', '黯綠', '褐', '金黃','美麗','漂亮','開開心心','怒','尷尬','時間管理','努力的','亭亭玉立','忿忿不平','嘻嘻哈哈','淺藍','閃亮','暗', '好奇', '帥氣', '討人喜愛的', '受人喜歡的', '天然呆的', '圓滾滾的', '懶洋洋的', '烏拉拉的', '尖叫的', '正在條繩的', '奔跑的', '在唱歌的', '跌倒的', '在游泳的']
    const n = ['寶寶','獨角獸','大師','打工仔','老司機','美少女','葛格','恐龍化石','小寶貝','水水','大學生','小強','小學生', '香蕉','教授','鯊魚','饒舌歌手','湯姆貓','米奇老鼠','小飛象','小公主','美人魚','花木蘭', '柴柴', '小水獺', '小企鵝', '小公雞', '小貓咪', '肥肉', '西瓜', '飯糰', '油條', '奶茶', '三明治', '肉狗', '火腿'] 
